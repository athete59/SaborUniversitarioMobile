...
export default function ResumoPedido() {
  ...
  async function confirmarPedido() {
    ...
    try {
      ...
      const statusInicial =
        formaPagamento === "Pix" ? "Pendente" : "Em preparo";
      ...
      // 3. Se for Pix, chama a Edge Function para obter o Copia e Cola do Mercado Pago
      if (formaPagamento === "Pix") {
        const { data: pixData, error: erroPix } =
          await supabase.functions.invoke("criar-pagamento-pix", {
            body: {
        ...
        if (erroPix || !pixData?.copiaECola) {
          throw new Error(
            erroPix?.message ||
              "Não foi possível gerar a chave Pix com o servidor.",
          );
        }
        ...
        Alert.alert(
          "Pedido Confirmado!",
          "Seu pedido foi registrado com sucesso. Acesse a tela de Meus Pedidos para acompanhar.",
          [
            {
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.centerContainer}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Text style={styles.btnVoltarCardapioTexto}>
              Voltar ao Cardápio
            </Text>
          </TouchableOpacity>
        </View>
      ...
      >
        ...
        <View style={styles.cardProdutoBox}>
          {itens.map((produto, index) => {
            ...
            const subtotalItem =
              (isNaN(precoNumerico) ? 0 : precoNumerico) * produto.quantidade;
